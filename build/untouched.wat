(module
 ...
 (func $~lib/internal/typedarray/TypedArray<i32>#__set (; 4 ;) (type $FUNCSIG$viii) (param $0 i32) (param $1 i32) (param $2 i32)
  (local $3 i32)
  (local $4 i32)
  (local $5 i32)
  (local $6 i32)
 ...
 (func $assembly/index/sum (; 5 ;) (type $FUNCSIG$ii) (param $0 i32) (result i32)
  (local $1 i32)
  (local $2 i32)
  (local $3 i32)
  i32.const 0
 ...
 (func $~lib/allocator/tlsf/__memory_reset (; 29 ;) (type $FUNCSIG$v)
  unreachable
 )
